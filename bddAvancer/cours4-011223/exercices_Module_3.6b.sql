...
Create table O_artiste of artiste_t(
...
SELECT * from o_tableau;

SELECT * from o_artiste;

delete from o_tableau where taid =4;


SELECT ref(oa) from o_artiste oa where oa.arid=1;
