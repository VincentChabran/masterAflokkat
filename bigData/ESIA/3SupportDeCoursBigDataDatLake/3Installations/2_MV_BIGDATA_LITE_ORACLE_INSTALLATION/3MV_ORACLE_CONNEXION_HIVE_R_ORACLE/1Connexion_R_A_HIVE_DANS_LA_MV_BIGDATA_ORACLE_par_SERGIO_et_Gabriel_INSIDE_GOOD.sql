...
--
result <- dbGetQuery(conn, "SELECT name, address, dnaiss FROM userProfile_hive_ext UNION ALL SELECT name, address, dnaiss FROM emp_hive_hadoop_ext");

result <- dbGetQuery(conn, "SELECT name, address, dnaiss FROM userProfile_hive_ext");


result <- dbGetQuery(conn, "SELECT name, address, dnaiss FROM emp_hive_hadoop_ext");
