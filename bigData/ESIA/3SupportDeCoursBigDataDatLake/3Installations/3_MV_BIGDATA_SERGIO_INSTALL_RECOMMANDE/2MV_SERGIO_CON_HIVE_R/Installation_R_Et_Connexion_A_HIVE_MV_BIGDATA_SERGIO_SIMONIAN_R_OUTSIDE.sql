...
# Lancer le serveur HIVE si non fonctionnel
...
## télécharger le jar ici
https://repo1.maven.org/maven2/org/apache/hive/hive-jdbc/3.1.3/
hive-jdbc-3.1.3-standalone.jar
hive-jdbc-3.1.3-standalone.jar
#10.0.2.2:10000
# Attention redirection fichier dans Vagrantfile
# ligne mettre dans ce fichier
# Redirection du port 1000 de hive
#Permet l''accès depuis windows. Ligne a mettre dans Vagrantfile ci-dessous
# config.vm.network "forwarded_port", guest: 10000, host: 10000

hive_jdbc_jar <- "D:/1agm05092005/5Logiciels_new/R4/R-4.2.2/hive-jdbc-3.1.3-standalone.jar"
hive_driver <- "org.apache.hive.jdbc.HiveDriver"
#hive_url <- "jdbc:hive2://10.0.2.15:10000"
